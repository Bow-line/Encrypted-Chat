...
class GUI:
    ...
    def layout(self, name):
        ...
        self.buttonMsg = Button(self.labelBottom, text="Send", font="Helvetica 10 bold", width=20, bg="#ABB2B9", command=lambda: self.sendMsgButton(self.entryMsg.get()))
        self.buttonMsg.place(relx=0.77, rely=0.008, relheight=0.03, relwidth=0.22)
        self.buttonFile = Button(self.labelBottom, text="File", font="Helvetica 10 bold", width=20, bg="#ABB2B9", command=lambda: self.sendFile(self))
    ...
    def sendFileButton(self):
        ...
        snd = threading.Thread(target=self.sendFile(file_data))
        snd.start()
